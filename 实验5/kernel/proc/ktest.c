...
void test_performance(void) {
    ...
    printf("Created and cleaned up %d processes in %d time units\n", num_procs, (int)(elapsed));
    printf("Average: %d time units per process\n", (int)(elapsed / num_procs));
    ...
    printf("Performed %d context switches in %d time units\n", num_switches, (int)(elapsed));
    printf("Average: %d time units per switch\n", (int)(elapsed / num_switches));
    ...
    end_time = get_time();
    elapsed = end_time - start_time;
    printf("Performed %d lock acquire/release in %d time units\n", num_acquires, (int)elapsed);
    printf("Average: %d time units per lock operation\n", (int)(elapsed / num_acquires));
...
void run_all_tests() {
    printf("\n");
    printf("========================================\n");
    printf("  RISCV-OS COMPREHENSIVE TEST SUITE    \n");
    printf("========================================\n");
    printf("\n");
    ...
    // 优先级系统调用和Aging机制测试
    printf("\n>>> PRIORITY SYSTEM CALLS & AGING TESTS <<<\n");
    test_priority_syscalls();
    debug_proc_table();
    test_aging_mechanism();
    debug_proc_table();
    test_comprehensive_priority_scheduling();
    debug_proc_table();
    ...
    // 时间片轮转和饥饿防护测试
    printf("\n>>> ROUND-ROBIN & STARVATION PREVENTION TESTS <<<\n");
    test_round_robin_scheduling();
    debug_proc_table();
    test_aging_starvation_prevention();
    debug_proc_table();
